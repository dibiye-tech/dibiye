  ...
  return (
    <div className="py-5 w-full max-w-[90rem] flex flex-col md:flex-row justify-start items-center my-4 md:my-6 lg:my-8 container mx-auto px-10 md:px-5">
      ...
      <div className="flex justify-start items-center w-full">
        {showNavigation && (
          <button
            className="bg-[#2278AC] text-white rounded-xl px-5 py-2 text-sm sm:text-base font-bold flex items-center transition duration-200 hover:bg-[#1A5D84] hover:text-gray-100"
            onClick={handleBack}
          >
