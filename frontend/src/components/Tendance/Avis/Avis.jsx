        ...
        <Slider {...settings}>
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className="text-black flex flex-col px-4 py-4">
              <div
                className="rounded-lg shadow-lg p-6 max-w-[360px] md:max-w-[400px] lg:max-w-[450px] lg:ml-10 hover:scale-105 transition-transform duration-300 ease-in-out h-[400px]"
                style={{
                  backgroundColor: 'rgba(34, 120, 172, 0.7)', // Fond avec opacité
                }}
              >
                ...
                <div className="flex flex-col gap-4 h-full">
                  ...
                  <div className="flex justify-between items-center mt-auto">
                    <h1 className="font-bold text-white text-md lg:text-xl">
                      {testimonial.name}
                    </h1>
