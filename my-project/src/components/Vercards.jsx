        ...
        <div className="w-full max-w-[90rem] mx-auto p-4 sm:p-6 md:p-8 bg-white rounded-3xl shadow-lg">
          <div className="flex flex-col lg:flex-row gap-4 md:gap-6">
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-start">
              <h1 className="font-bold text-xl md:text-2xl lg:text-3xl text-primary mt-2 lg:mt-4">
                {subcategory.name}
              </h1>
              <p className="text-sm md:text-base lg:text-lg mt-2 md:mt-4">{subcategory.description}</p>
            </div>
          </div>
        </div>
      </div>
