...
const CardsUni = () => {
  ...
  return (
    <div className="my-10 mx-auto container">
      <div>
        <h1 className="text-center capitalize font-bold text-secondary text-shadow-sm text-2xl pt-10 pb-2">
                  ...
                  <div className="flex flex-col">
                    <div className="overflow-hidden">
                      <img
                        ...
                        alt={university.name}
                        className="rounded-t-3xl h-[250px] sm:h-[280px] lg:h-[300px] w-full object-cover"
                      />
                    </div>
                    ...
                    <div className="p-4 text-center">
                      ...
                      <p className="text-sm lg:text-base text-secondary py-2">
                        Cliquez ici
                      </p>
                    </div>
                  </div>
